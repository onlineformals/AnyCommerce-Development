...
//the cart messaging is OUTSIDE the template. That way if the template is re-rendered, existing messaging is not lost.
					if($modal.length)	{
						...
						$modal.dialog({modal: true,width:'80%', dialogClass: 'dlgfixed', position: "center"});  //browser doesn't like percentage for height  //browser doesn't like percentage for height
						}
